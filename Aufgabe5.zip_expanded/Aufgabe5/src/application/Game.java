...
public class Game {
     ...
     */
    protected synchronized boolean start(QuizError error) throws ParserConfigurationException, Exception {
     ...
     * @throws ParserConfigurationException 
     */
    private void assignQuestions() throws ParserConfigurationException, Exception {
